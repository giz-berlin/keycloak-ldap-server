...
The API should now be available at `ldap[s]://0.0.0.0:3000`. To see all available configuration options, please check out [config.rs](./ldap-lib/src/config.rs).
...
1. Assign role `realm-management: view-users` under "Client roles".
